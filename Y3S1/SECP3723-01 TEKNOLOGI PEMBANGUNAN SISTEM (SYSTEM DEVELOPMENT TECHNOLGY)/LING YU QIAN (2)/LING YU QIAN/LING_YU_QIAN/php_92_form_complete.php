...
<h2>PHP Form Validation Contoh</h2>
<p><span class="error">* medan diperlukan</span></p>
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <br><br>
  Laman web: <input type="text" name="website" value="<?php echo $website;?>">
  <span class="error"><?php echo $websiteErr;?></span>
  <br><br>
  Komen: <textarea name="comment" rows="4" cols="35"><?php echo $comment;?></textarea>
  <br><br>
  Janita:
  <input type="radio" name="gender" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female">Perempuan
  <input type="radio" name="gender" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male">Lelaki
